...
const AUTH_BASE_URL = process.env.AUTH_BASE_URL || "https://your-api-domain.com/auth/api/v1";
const ASSISTANTS_BASE_URL = process.env.ASSISTANTS_BASE_URL || "https://your-api-domain.com/assistants/api/v1";
